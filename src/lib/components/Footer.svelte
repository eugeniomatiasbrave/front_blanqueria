  ...
  <div class="container">
    <div class="grid md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <p class="text-gray-300 mb-4">Recibe las últimas novedades y ofertas exclusivas.</p>
        <form class="flex">
          <input 
            type="email" 
            placeholder="Tu correo" 
            class="bg-gray-700 text-white px-4 py-2 rounded-l-lg w-full focus:outline-none focus:ring-2 focus:ring-primary"
            required
          />
          <button 
            type="submit" 
            class="bg-primary hover:bg-opacity-90 text-white px-4 py-2 rounded-r-lg"
          >
